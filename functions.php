...
add_action( 'wp_enqueue_scripts', 'pi_theme_scripts' );
...
*/
function pi_theme_preload( $hints, $relation_type ){
...
add_filter( 'wp_resource_hints', 'pi_theme_preload', 10, 2 );
/*----End global scripts--/
